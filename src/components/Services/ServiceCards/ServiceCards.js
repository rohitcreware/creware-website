...
const ServiceCards = ({ portfolioList, propsComingFrom }) => {
  return (
    <>
              ...
              <Link
                href={
                  propsComingFrom === "services"
                    ? "/our-projects/project-details"
                    : "./project-details"
                }
              >
                <div className={`${styles["card-1"]} card`}>
                  <div
                    className={`${styles["card-img-overlay"]} overflow-hidden`}
                  >
                    <img
                    ...
                    ></div>
                    <div
                      className={`${styles["overlay"]} ${styles["red"]} ps-2 pt-2`}
                    >
                      <h6 className={`${styles["animated-h6"]} text-start`}>
                        Company
                      </h6>
                      ...
                      <div
                        className={`${styles["animated-p-div"]} mt-0 position-absolute mb-2 bottom-0`}
                      >
                        <p className={`${styles["animated-p"]} m-0 text-start`}>
                          Web design
                        </p>
                        <p className={`${styles["animated-p"]} m-0 text-start`}>
                          Figma
